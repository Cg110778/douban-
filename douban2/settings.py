...
DOWNLOADER_MIDDLEWARES = {
      'douban2.middlewares.RandomUserAgent':480,
      #'douban2.middlewares.ProxyMiddleware':100,
      #'douban2.middlewares.CookiesMiddleware':554,
      # 'douban2.middlewares.DoubanDownloaderMiddleware': 543,
...
ITEM_PIPELINES = {
   #'douban1.pipelines.DoubanPipeline': 300,
   'douban2.pipelines.MongoPipeline':302,
}
